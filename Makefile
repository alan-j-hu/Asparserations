...
#Grammar
build/grammar.o: build grammar/src/grammar.cpp grammar/include/grammar.hpp \
grammar/include/production.hpp
	$(CXX) $(CXXFLAGS) -c -o build/grammar.o grammar/src/grammar.cpp

build/nonterminal.o: build grammar/src/nonterminal.cpp \
grammar/include/nonterminal.hpp
	$(CXX) $(CXXFLAGS) -c -o build/nonterminal.o grammar/src/nonterminal.cpp

build/token.o : build grammar/src/token.cpp grammar/include/token.hpp
	$(CXX) $(CXXFLAGS) -c -o build/token.o grammar/src/token.cpp

build/production.o : build grammar/src/production.cpp \
grammar/include/production.hpp
	$(CXX) $(CXXFLAGS) -c -o build/production.o grammar/src/production.cpp

#Table
build/table.o : build table/src/table.cpp table/include/table.hpp \
table/include/item_set.hpp grammar/include/token.hpp
	$(CXX) $(CXXFLAGS) -c -o build/table.o table/src/table.cpp

build/lr_table.o : build table/src/lr_table.cpp grammar/include/grammar.hpp \
...
build/lalr_table.o : build table/src/lalr_table.cpp \
table/include/lalr_table.hpp table/include/item_set.hpp
	$(CXX) $(CXXFLAGS) -c -o build/lalr_table.o table/src/lalr_table.cpp

build/item.o : build table/src/item.cpp table/include/item.hpp
	$(CXX) $(CXXFLAGS) -c -o build/item.o table/src/item.cpp

build/item_set.o : build table/src/item_set.cpp table/include/item_set.hpp
	$(CXX) $(CXXFLAGS) -c -o build/item_set.o table/src/item_set.cpp

build/state.o : build table/src/state.cpp table/include/state.hpp \
grammar/include/production.hpp grammar/include/symbol.hpp
	$(CXX) $(CXXFLAGS) -c -o build/state.o table/src/state.cpp

#Codegen
build/json_generator.o : build codegen/src/json_generator.cpp
	$(CXX) $(CXXFLAGS) -c -o build/json_generator.o \
codegen/src/json_generator.cpp

#Miscellaneous
build/grammar_syntax.o : build bootstrap/src/grammar_syntax.cpp \
bootstrap/include/grammar_syntax.hpp
	$(CXX) $(CXXFLAGS) -c -o build/grammar_syntax.o \
bootstrap/src/grammar_syntax.cpp

build/first_set1.o : build tests/src/first_set1.cpp \
...
build/print_states.o : build tests/src/print_states.cpp \
...
build/lr_table1.o : build tests/src/lr_table1.cpp
	$(CXX) $(CXXFLAGS) -c -o build/lr_table1.o tests/src/lr_table1.cpp

build/lalr_table1.o : build tests/src/lalr_table1.cpp
...
build/gen_json.o : build bootstrap/src/gen_json.cpp \
...
build/lexer.o : build bootstrap/src/lexer.cpp bootstrap/include/lexer.hpp
	$(CXX) $(CXXFLAGS) -c -o build/lexer.o bootstrap/src/lexer.cpp

build/parser.o : build autogen/src/Parser.cpp autogen/include/Parser.hpp
	$(CXX) $(CXXFLAGS) -c -o build/parser.o autogen/src/Parser.cpp

build/callback.o : build bootstrap/src/callback.cpp \
bootstrap/include/callback.hpp autogen/include/Parser.hpp
	$(CXX) $(CXXFLAGS) -c -o build/callback.o bootstrap/src/callback.cpp

build/main.o : build main.cpp autogen/include/Parser.hpp \
bootstrap/include/lexer.hpp bootstrap/include/callback.hpp \
codegen/include/json_generator.hpp grammar/include/grammar.hpp \
table/include/lr_table.hpp
	$(CXX) $(CXXFLAGS) -c -o build/main.o main.cpp

#Executables
bin/first_set1.out : bin build/first_set1.o build/grammar_syntax.o \
$(GRAMMAR_OBJS)
	$(CXX) -std=c++11 -o bin/first_set1.out build/first_set1.o \
build/grammar_syntax.o $(GRAMMAR_OBJS)

bin/lr_table1.out : bin build/lr_table1.o build/print_states.o $(GRAMMAR_OBJS) \
$(TABLE_OBJS)
	$(CXX) -std=c++11 -o bin/lr_table1.out build/lr_table1.o \
build/print_states.o $(GRAMMAR_OBJS) $(TABLE_OBJS)

bin/lalr_table1.out : bin build/lalr_table1.o build/print_states.o \
$(GRAMMAR_OBJS) $(TABLE_OBJS)
	$(CXX) -std=c++11 -o bin/lalr_table1.out build/lalr_table1.o \
build/print_states.o $(GRAMMAR_OBJS) $(TABLE_OBJS)

bin/json_test1.out : bin build/json_test1.o $(GRAMMAR_OBJS) $(TABLE_OBJS) \
$(CODEGEN_OBJS)
	$(CXX) -std=c++11 -o bin/json_test1.out build/json_test1.o \
$(GRAMMAR_OBJS) $(TABLE_OBJS) $(CODEGEN_OBJS)

bin/gen_json.out : bin build/gen_json.o $(GRAMMAR_OBJS) $(TABLE_OBJS) \
...
bin/asparserations : bin build/main.o $(GRAMMAR_OBJS) $(TABLE_OBJS) $(CODEGEN_OBJS)\
...
autogen/include/Parser.hpp autogen/src/Parser.cpp : autogen/include \
autogen/src bootstrap/parser_gen.py bootstrap/output_json.json \
